$a = Get-ChildItem -Path "C:\Users\P114320a\Documents\WindowsPowershell\here\" -attributes !Directory; #"..copied from code
$g = $a |Group-Object {($_.BaseName -replace '\(\d+\)$', '').Trim()+$_.extension} #g was assigned on line 62
foreach($ex in $g){
    if($ex.count-gt 1){
